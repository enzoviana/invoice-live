...
class Client(models.Model):
    ...
    def get_absolute_url(self):
        return Reversible('client-detail', kwargs={'slug': self.slug})
...
class Invoice(models.Model):
    ...
    def get_absolute_url(self):
        return Reversible('invoice-detail', kwargs={'slug': self.slug})
...
class Product(models.Model):
    ...
    def get_absolute_url(self):
        return Reversible('product-detail', kwargs={'slug': self.slug})
...
class Settings(models.Model):
    ...
    def get_absolute_url(self):
        return Reversible('settings-detail', kwargs={'slug': self.slug})
